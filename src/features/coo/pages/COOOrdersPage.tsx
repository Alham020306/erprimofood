...
import { useCOOOrders } from "../hooks/useCOOOrders";
...
export default function COOOrdersPage() {
  const {
    loading,
    orders,
    summary,
  ...
  const orderMapContainerId = "coo-order-detail-google-map";

  if (loading) return <div>Loading COO orders...</div>;
  ...
  return (
    <div className="space-y-6">
      ...
      <OrderTable data={orders} onSelect={setSelectedOrder} />
