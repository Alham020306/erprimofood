...
export const roleThemes: Record<UserRole, RoleTheme> = {
  ...
  [UserRole.CFO]: {
    shell:
      "bg-[radial-gradient(circle_at_top,_rgba(34,197,94,0.14),_transparent_24%),radial-gradient(circle_at_bottom_right,_rgba(168,85,247,0.12),_transparent_28%),linear-gradient(180deg,_#030712_0%,_#111827_42%,_#0f172a_100%)]",
    sidebar: "bg-slate-950/82 backdrop-blur-xl",
    sidebarBorder: "border-emerald-500/18",
    sidebarMuted: "text-emerald-300/70",
    topbar: "bg-slate-950/70 backdrop-blur-xl",
    topbarBorder: "border-emerald-500/18",
    topbarAccent: "from-emerald-400 via-blue-500 to-violet-500",
    panel: "border-emerald-500/14 bg-slate-950/76 shadow-[0_24px_90px_rgba(16,185,129,0.16)]",
    accentText: "text-emerald-300",
    accentSoft: "bg-gradient-to-r from-emerald-500/12 via-blue-500/12 to-violet-500/12",
    activeNav: "bg-gradient-to-r from-emerald-500 via-blue-500 to-violet-500 text-white shadow-[0_12px_40px_rgba(59,130,246,0.28)]",
    idleNav: "bg-slate-900/70 text-slate-200 hover:bg-slate-800/85",
